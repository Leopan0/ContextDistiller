/* context-distiller client bundle — built 2026-09-21T14:42:31.318Z */
...
function SettingsPanel({ t }) {
  ...
  const [filterFlagged, setFilterFlagged] = (0, import_react.useState)(false);
  const [wan, setWan] = (0, import_react.useState)(0);
  ...
  return import_react.default.createElement(
    ...
    import_react.default.createElement("hr", { style: S.divider }),
    import_react.default.createElement("h4", { style: S.sectionTitle }, t("filterSection")),
    import_react.default.createElement(
      "div",
      { style: S.row },
      import_react.default.createElement(
    ...
    import_react.default.createElement("div", { style: { ...S.hint, marginTop: "0" } }, t("filterHint")),
    // Absolute-threshold section (independent of both toggles)
    import_react.default.createElement("hr", { style: S.divider }),
    import_react.default.createElement("h4", { style: S.sectionTitle }, t("thresholdSection")),
    import_react.default.createElement(
      "div",
      { style: S.row },
      import_react.default.createElement("label", { style: S.label }, t("thresholdLabel")),
      import_react.default.createElement("input", {
        type: "number",
        style: S.select,
        min: 0,
        ...
        step: 1,
        value: wan,
        onChange: (e) => setWan(Number(e.target.value) || 0)
      })
    ),
    import_react.default.createElement("div", { style: { ...S.hint, marginTop: "0" } }, t("thresholdHint")),
    // Save
    import_react.default.createElement(
      "button",
      {
